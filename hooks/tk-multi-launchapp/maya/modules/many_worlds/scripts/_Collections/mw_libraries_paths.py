...
# Many worls ui files.
mw_ui_stylesheets = {
    "generic": "C:/Many-Worlds/pipeline/shotgun/pipeline_configuration/hooks/tk-multi-launchapp/maya/modules/many_worlds/scripts/_Libraries/QT/StyleSheets/generic_Stylesheet.qss",

...
from Widgets import mw_QPushButton, mw_QFrame, mw_QImportJoints, \
...
class MWQSkeletonModule(QtWidgets.QWidget):
    """ Many Worlds custom QDialog class. """
    def __init__(self, parent=None):
        super(MWQSkeletonModule, self).__init__(parent)
        self.mw_type_id = "MWQSkeletonModule"
    ...
    def create_widgets(self):
        ...
        self.tittle = mw_QLabel.MWQLabel(
            custom_text="Many-Worlds Skeleton Builder Module",
            aligment="rigth",
        )
        self.lod_label = QtWidgets.QLabel("Choose Skeleton Rig Definition:  ")
    ...
    def create_connections(self):
        self.create_module.clicked.connect(self.create_skeleton_module)
    ...
    def create_skeleton_module(self):
        ...
        mw_pyside_utils.MWWidgetsFunctions.add_tab(
            self.tab_widget,
            self.create_skeleton_session(),
            "skeleton_rig_builder_LOD_{}".format(self.lod_type.currentText())
        )

    def create_skeleton_session(self):

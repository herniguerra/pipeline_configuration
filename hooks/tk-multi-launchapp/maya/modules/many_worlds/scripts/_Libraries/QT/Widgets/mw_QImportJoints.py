...
class MWQImportJoints(QtWidgets.QWidget):
    """ Many Worlds custom import joint module. """
    def __init__(self, parent=None):
        super(MWQImportJoints, self).__init__(parent)
        self.mw_type_id = "MWQImportJoints"
        self.mw_long_type_id = "mw_QImportJoints.MWQImportJoints"
        self.serialize_type = "text"
        self.main_parent = parent
        self.create_widgets()
        self.create_layouts()
        self.create_connections()
        self.widget_data = self.file_path.text()
    ...
    def create_layouts(self):
        ...
        self.base_layout.addWidget(self.load_joints_button)
        self.base_layout.addWidget(self.set_load_joint_from_list_button)
    ...
    def create_widgets(self):
        ...
        self.import_button = mw_QPushButton.MWQPushButton("Import Joints")
        self.load_joints_button = mw_QPushButton.MWQPushButton(
            icon_type="file_open"
        )
        self.file_path = mw_QLineEdit.MWQLineEdit("Joints Path...")
        ...
        self.import_button.setMaximumSize(1136, 20)

...
from _Libraries.QT.Widgets import mw_QPushButton, mw_QLineEdit, mw_QFrame, mw_QCheckBox,\
     mw_QLabel, mw_QImportModule, mw_QGroupBox, mw_QtDialog, mw_QAssetLibrary
...
class MWQPackageBuilder(mw_QtDialog.MWQDialog):
    ...
    def create_layouts(self):
        ...
        self.file_explorer.setMaximumSize(500, 1000)
        ...
        self.package_builder.setMinimumSize(300, 500)
        self.package_builder.setMaximumSize(880, 600)
        self.package_builder.resize(880, 600)
    ...
    def add_widgets(self):
        ...
        self.base_layout.addWidget(self.import_body)
    ...
    def create_widgets(self):
        ...
        self.import_body = mw_QImportModule.MWQImportModule(
            "MWQImportModule",
            "mw_QImportPackage.MWQImportModule",
            "text",
            "Skin",
    ...
    def create_connections(self):
        ...
        """
        self.build_button.clicked.connect(self._build_package_data)


    def _build_package_data(self):
        """ Build the anatomical package from inputted data. """

        mw_pyside_utils.MWWidgetsFunctions.execute_session(

    ...
    def execute(
        ...
        if engine_name == "tk-maya":
            sgtk.util.append_path_to_env_var(
                "PYTHONPATH", os.path.append(self.disk_location, "maya")
            )
            sgtk.util.append_path_to_env_var(
                "MAYA_MODULE_PATH", os.path.append(self.disk_location, "maya/modules")
            )
            sgtk.util.append_path_to_env_var(
                "MAYA_SCRIPT_PATH", os.path.append(self.disk_location, "maya/scripts")
            )
